...
- Create Angular project with ng: `ng new detailedcountries.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`detailedcountries.client.esproj`).
